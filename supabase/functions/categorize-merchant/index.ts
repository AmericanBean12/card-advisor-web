  ...
  try {
    ...
    const res = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 50,
        system:
          "Classify this merchant or purchase description into exactly one category. Respond with ONLY the category name. Valid categories: dining, groceries, flights, hotels, gas, transit, streaming, online_shopping, drugstores, home_improvement, car_rental, travel, entertainment, phone_plans, fitness, shipping, general",
